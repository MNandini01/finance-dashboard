...
- 📋 Transaction list with details (date, category, amount, type)
...
This project focuses on building a clean and user-friendly dashboard interface using mock data.  
...
- Add charts (balance trends, spending breakdown)
